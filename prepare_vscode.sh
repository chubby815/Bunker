...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  setpath "product" "nameShort" "Bunker"
  setpath "product" "nameLong" "Bunker"
  setpath "product" "applicationName" "bunker"
  setpath "product" "linuxIconName" "bunker"
  setpath "product" "quality" "stable"
  setpath "product" "urlProtocol" "bunker"
  setpath "product" "serverApplicationName" "bunker-server"
  setpath "product" "serverDataFolderName" ".bunker-server"
  setpath "product" "darwinBundleIdentifier" "com.bunker"
  setpath "product" "win32AppUserModelId" "Bunker.Bunker"
  setpath "product" "win32DirName" "Bunker"
  setpath "product" "win32MutexName" "bunker"
  setpath "product" "win32NameVersion" "Bunker"
  setpath "product" "win32RegValueName" "Bunker"
  setpath "product" "win32ShellNameShort" "Bunker"
  setpath "product" "win32AppId" "{{CBF21A8A-DDD3-4D89-AC28-8662D20DF4EC}"
  setpath "product" "win32x64AppId" "{{A23DC917-1133-4E6A-9220-137668D95A3F}"
  setpath "product" "win32arm64AppId" "{{2375431F-7C1E-450A-814B-B86BDE96A3D3}"
  setpath "product" "win32UserAppId" "{{0901BE0F-89EC-42B4-A179-26A0F83CEB8B}"
  setpath "product" "win32x64UserAppId" "{{E7ECEF11-1635-4BDA-A917-29ADD39F6C69}"
  setpath "product" "win32arm64UserAppId" "{{87B0BF9E-BE31-4F1A-9F44-8751217BFEB4}"
  setpath "product" "tunnelApplicationName" "bunker-tunnel"
  setpath "product" "win32TunnelServiceMutex" "bunker-tunnelservice"
  setpath "product" "win32TunnelMutex" "bunker-tunnel"
...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  setpath "resources/server/manifest" "name" "Bunker"
  setpath "resources/server/manifest" "short_name" "Bunker"
fi
